package ru.kpfu.itis.charntsev.classwork.fx;
...
public class JavaFxApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        alert.setContentText("First time in our application?");
        ...
        primaryStage.setTitle("Hello javafx. First time?");
        primaryStage.setScene(main);
        primaryStage.show();

        KeyCombination kc = new KeyCodeCombination(KeyCode.TAB, KeyCombination.CONTROL_ANY);
